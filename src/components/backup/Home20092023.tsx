  ...
  return (
    <div className="main-content">
      <Container
        ...
        className="debug"
      >
        <section id="page1" style={{ width: "100vw", overflow: "hidden" }}>
          <Row
            style={{
            ...
            <Col>
              ...
              <Row style={{ height: "10%" }}>
                <Col
                  style={{
                    backgroundImage: `url(${
                      !isAudioPlaying3 ? audio_2_mobile : audio_2_mobile_playing
                    })`,
                    backgroundSize: "50%",
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: "center",
        ...
        >
          ...
          >
            <Col style={{ height: "100%", width: "100%", padding: "0px" }}>
              <BannerElectronicoMobile text="TransMiCable nos proporciona un aire mas limpio" />
              <Row
                style={{
                  height: "45%",
                  justifyContent: "center",
          ...
          >
            <Col style={{ height: "100%", padding: "0px" }}>
              ...
              <Row style={{ height: "12%" }}>
                ...
                >
                  La percepción de inseguridad y la vitimización (hogares
                  víctimas de hurto y robo) disminiuyó en la zona de influencia
                  del TransMiCable después de su implementación.
                </p>
              </Row>
              <Row
                style={{
                  height: "10%",
                  backgroundImage: `url(${
                    !isAudioPlaying5 ? audio_2_mobile : audio_2_mobile_playing
                  })`,
                  backgroundSize: "50%",
                  backgroundRepeat: "no-repeat",
                  backgroundPosition: "center",
        ...
        >
          ...
          >
            ...
            >
              ...
              <Row style={{ height: "15%", margin: "2rem" }} className="debug">
                <p
                  style={{
                    textAlign: "center",
                    color: "#32677F",
              ...
              <Col lg={6} md={6} sm={12} xs={12}>
                ...
                <Row
                  style={{
                    height: "25%",
                    backgroundImage: `url(${
                      !isAudioPlaying7 ? audio_2_mobile : audio_2_mobile_playing
                    })`,
                    backgroundSize: "50%",
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: "center",
        ...
        >
          ...
          >
            <Row style={{ height: "25%", width: "75%", padding: "0px" }}>
              <div
                style={{
                  backgroundImage: `url(${banner_subtitulo})`,
                  backgroundSize: "contain",
            ...
            >
              <Col
                style={{ marginLeft: "7%", marginRight: "7%", padding: "0px" }}
              >
                <Row style={{ padding: "0px", justifyContent: "center" }}>
                  <div
                    style={{
